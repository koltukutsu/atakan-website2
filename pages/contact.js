      ...
      <Container>
        ...
        <div className="grid my-10 md:grid-cols-2">
          <div className="my-10">
            ...
            <p className="max-w-sm mt-0">
              Formu doldurun ve bize email gönderin veya bizi arayın.
            </p>
          ...
          <div>
            ...
            {isSubmitSuccessful && !isSuccess && (
              <div className="mt-3 text-sm text-center text-red-500">
                {message || "Birşeyler ters gitti. Lütfen yeniden deneyin."}
              </div>
            )}
          </div>
        </div>
